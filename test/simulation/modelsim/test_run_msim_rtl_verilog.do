...
vlog -vlog01compat -work work +incdir+D:/Quartus/work/rs232/test {D:/Quartus/work/rs232/test/test.v}

vlog -vlog01compat -work work +incdir+D:/Quartus/work/rs232/test {D:/Quartus/work/rs232/test/tb_test.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_test
